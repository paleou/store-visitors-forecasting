...
- Modular design using Prophet mechanism.
...
Alternatively this project can also be deployed and automated on GCP, using Nixtla models:
...
- Vertex AI → Train and serve models in a managed environment.
